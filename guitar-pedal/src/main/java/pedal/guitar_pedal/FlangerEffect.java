...
/**
 * <p>
 * Adds a flanger effect to a signal. The implementation is done with a delay buffer and an LFO in the form of a sine
 * wave. It is probably the most straightforward flanger implementation possible.
 * </p>
 * 
 * @author Joren Six
 */
public class FlangerEffect implements AudioProcessor
{
    ...
    /**
     * A simple delay buffer, it holds a number of samples determined by the maxFlangerLength and the sample rate.
     */
    ...
    /**
     * Determines the factor of original signal that remains in the final mix. Dry should always equal 1-wet).
     */
    private float dry;
    /**
     * Determines the factor of flanged signal that is mixed in the final mix. Wet should always equal 1-dry.
     */
    private float wet;
    /**
     ...
     *            in seconds
     * @param wet
     *            The 'wetness' of the flanging effect. A value between 0 and 1. Zero meaning no flanging effect in the
     *            resulting signal, one means total flanging effect and no original signal left. The dryness of the
     *            signal is determined by dry = "1-wet".
     * @param sampleRate
    ...
    /**
     * Sets the wetness and dryness of the effect. Should be a value between zero and one (inclusive), the dryness is
     * determined by 1-wet.
     * 
     * @param wet
     *            A value between zero and one (inclusive) that determines the wet and dryness of the resulting mix.
     */
    ...
    /**
     * Sets the wetness and wetness of the effect. Should be a value between zero and one (inclusive), the wetness is
     * determined by 1-dry.
     * 
     * @param dry
     *            A value between zero and one (inclusive) that determines the wet and dryness of the resulting mix.
